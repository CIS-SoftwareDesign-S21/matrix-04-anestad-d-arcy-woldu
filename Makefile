...
create_data:	mmult.o mmult_simd.o create_data.o mat.c mmult_simd_O3.o
	gcc -o mmult -fopenmp mmult.o mmult_simd.o mmult_simd_O3.o create_data.o mat.c -o create_data
