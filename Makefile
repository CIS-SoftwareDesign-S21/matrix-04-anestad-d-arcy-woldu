...
create_data:	mmult.o mmult_simd.o mmult_simd_O3.o create_data.o mat.c
	gcc -o mmult mmult.o mmult_simd.o mmult_simd_O3.o create_data.o mat.c -o create_data
